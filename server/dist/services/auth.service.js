...
const signup = async (userData, locale = index_1.env.locale) => {
    ...
    (0, email_service_1.sendHTMLEmail)(createUserData.email, (0, i18n_1.__)({ phrase: 'Verify your email', locale }), (0, html_1.generateHTML)(path_1.default.join(__dirname, `/../emailTemplates/verify.email.template/${locale}.html`), args), { attachments: [{ filename: 'logo.png', path: (0, util_1.frontendAsset)('images/logo.png'), cid: 'logo' }] }).catch(err => logger_1.logger.error((0, i18n_1.__)({ phrase: err.message, locale })));
...
const forgotPassword = async (email, locale = index_1.env.locale) => {
    ...
    await (0, email_service_1.sendHTMLEmail)(findUser.email, (0, i18n_1.__)({ phrase: 'Reset your password', locale }), (0, html_1.generateHTML)(path_1.default.join(__dirname, `/../emailTemplates/reset.password.template/${locale}.html`), args), { attachments: [{ filename: 'logo.png', path: (0, util_1.frontendAsset)('assets/logo/logo-mail.jpeg'), cid: 'logo' }] }).catch(err => logger_1.logger.error((0, i18n_1.__)({ phrase: err.message, locale })));
    return findUser;
};
/**
